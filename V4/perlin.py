...
if __name__ == "__main__":
    ...
    save_elevation_map(noise, "images/elevation.png", dpi=200)

    print("Saving biome map...")
    save_biome_map(noise, moisture, temperature, "images/biomes.png", dpi=200)

    print("Saving combined map (biomes + contours)...")
    save_combined_map(noise, moisture, temperature, "images/combined.png",
                      dpi=200, contour_levels=20, contour_alpha=0.45)

    print("Saving biome legend...")
    save_biome_legend("images/biome_legend.png")
